...
namespace MY_MVC_APPLICATION.Controllers
{
    public partial class CountriesController
    {
        ...
        protected CountriesController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public CountriesController Actions { get { return MVC.Countries; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Countries";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Countries";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        {
            public readonly string inputViewModel = "inputViewModel";
        }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CountriesController : MY_MVC_APPLICATION.Controllers.CountriesController
    {
        public T4MVC_CountriesController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Models.Country inputViewModel);
